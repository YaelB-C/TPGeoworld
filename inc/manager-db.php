...
function GetNombrePays(){
    
    global $pdo;
    $query = 'SELECT DISTINCT COUNT(*) as NombrePays FROM Country';
    return $pdo->query($query)->fetch()->NombrePays;
}
function GetNombreVille(){
    
    global $pdo;
    $query = 'SELECT DISTINCT COUNT(*) as NombreVille FROM City';
    return $pdo->query($query)->fetch()->NombreVille;
}
?>